...
import { ItemsResInterface } from "../schemas/items_schema"
import {   user_id } from "../db/keys"
                                ...
                                <div className="mb-3">
                                   ...
                                   <ClampLines
                                    ...
                                    <div className="mb-2 d-flex gap-2">
                                        <a href={`https://wa.me/263771692396?text=Good day, i would like to get more information on this product - ${i.item_name} going for $ ${i.price.toFixed(2)} USD`} className={"w-100"} target={"_blank"}><button className={"btn btn-success w-100"}>Buy</button></a>
